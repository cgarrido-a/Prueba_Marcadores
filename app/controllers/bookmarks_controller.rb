class BookmarksController < ApplicationController
  ...
  def index
    ...
    @bookmark_pieChart =  Bookmark.group('varieties.name').joins(:variety).count
  ...
  def create
    ...
    respond_to do |format|
      if @bookmark.save
        ...
        format.js{redirect_to bookmarks_url,  notice: "Bookmark was successfully created."}
